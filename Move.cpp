...
//    {
//    	minS = platform->InstantDv(AXES+gCodes->GetSelectedHead()); //FIXME, FIXED: changed to use the current extruder);
//    	maxS = platform->MaxFeedrate(AXES+gCodes->GetSelectedHead()); // Picks up the value for the first extruder.  FIXME?
//    	maxA = platform->Acceleration(AXES+gCodes->GetSelectedHead());
//    	steps = platform->DriveStepsPerUnit(AXES+gCodes->GetSelectedHead());
