...
RepRapFirmware - Platform: RepRap Mendel90 with Duet&Duex4 controller
...
#define DIRECTIONS {true, true, true, true, true, true, true, true}
...
#define DRIVE_STEPS_PER_UNIT {80, 80, 4000.0, 655, 655, 655, 655, 420.0}
...
#define THERMISTOR_BETAS {4036, 3960.0, 3960.0, 3960.0, 3960.0, 3960.0}		// See http://en.wikipedia.org/wiki/Thermistor
